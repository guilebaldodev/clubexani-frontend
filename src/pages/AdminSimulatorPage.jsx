                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="td-center">100</td> <td className="td-center">1050</td>
                      <td>
                        <div className="container">
                    ...
                    <tr>
                      ...
                      <td className="td-center"> 110</td>
                      <td className="td-center"> 900</td>
                      <td>
                        <div className="container">
                          <img src="/icons/admin-icons/3points.png" alt="" />
                        </div>
...
export default AdminSimulatorsPage;