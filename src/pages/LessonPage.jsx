      ...
      <div className="lesson-content-container">
        ...
        <div className="lesson-content">
          ...
          <ul className="lesson-ul">
            ...
            <li>
              Entender los conceptos de ontología, epistemología y metodología
              en el contexto de cada paradigma.
            </li>
            <li>
          ...
          <p className="lesson-paragraph">
            ...
            que guían cómo los investigadores entienden y estudian los
            fenómenos. Antes de explorar los tres paradigmas principales, es
            crucial entender tres conceptos fundamentales:{" "}
            <strong>ontología</strong>, <strong>epistemología</strong> y{" "}
            <strong>metodología</strong>. Estos conceptos definen cómo los
            investigadores ven la realidad, cómo adquieren conocimiento y qué
            métodos utilizan en sus estudios.
          </p>
          ...
          <ol className="lesson-ol">
            <li>
              ...
              <div className="lesson-ol-text">
                ...
                <p>
                  La ontología se refiere a la naturaleza de la realidad o lo
                  que existe. En investigación, este concepto explora cómo
                  percibimos la realidad, si es objetiva y externa al
                  observador, o si es subjetiva y construida por las
            ...
            <li>
              ...
              <div className="lesson-ol-text">
                ...
                <p>
                  ...
                  cualitativos (como entrevistas y estudios de caso),
                  dependiendo de cómo el investigador ve la realidad y adquiere
                  conocimiento.
                </p>
              </div>
            </li>
          ...
          <p>
            El <strong>paradigma positivista</strong> se basa en la idea de que
            la realidad es objetiva y puede ser medida y analizada mediante
            métodos científicos. Este enfoque es característico de las ciencias
            naturales, donde el objetivo es descubrir leyes generales que
          ...
          <ul className="lesson-ul pt-16">
            ...
            <li>
              <strong>Epistemología:</strong> El conocimiento se obtiene a
              través de la observación y la medición empírica.
            </li>
            <li>
          ...
          <div className="example">
            ...
            <p>
              Un estudio que mide el impacto de un programa de ejercicio físico
              en la reducción del estrés en un grupo de trabajadores. El
              investigador usa un cuestionario estandarizado para medir los
              niveles de estrés antes y después del programa.
            </p>
          </div>
          ...
          <p>
            ...
            las experiencias humanas desde la perspectiva de los individuos.
            Aquí, la realidad es vista como subjetiva y construida socialmente.
            Este enfoque es común en las ciencias sociales y humanas.
          </p>
          <h4>Características principales:</h4>
          ...
          <ul className="lesson-ul">
            ...
            <li>
              <strong>Metodología:</strong> Se utilizan métodos cualitativos,
              como entrevistas y estudios de caso, para explorar los
          ...
          <p>
            ...
            transformar las estructuras sociales y culturales. Este enfoque
            busca identificar y cuestionar las desigualdades y las dinámicas de
            poder en la sociedad, promoviendo una visión crítica que permita el
            cambio social. Los investigadores sociocríticos no solo analizan las
          ...
          <h3>Resumen:</h3>
          <p>
            En esta lección, hemos revisado los tres paradigmas principales de
            la investigación: positivista, interpretativo y crítico. Cada uno de
            estos enfoques ofrece una manera distinta de comprender y estudiar
            la realidad. Mientras que el paradigma positivista se centra en la
        ...
        <div className="lesson-done">
          ...
          <p>
          ¡Has completado esta lección! Ahora es el momento de demostrar lo que has aprendido con una pequeña evaluacion. ¿Estás listo para poner a prueba tus conocimientos?
          </p>
          <button>
            Iniciar evaluacion
          </button>
